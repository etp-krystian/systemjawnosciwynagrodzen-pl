...
layout: base
locale: pl
title: Drugi projekt ustawy o jawności wynagrodzeń. Co się wyjaśniło i na co firmy powinny patrzeć teraz
description: Nowy projekt polskich przepisów o jawności wynagrodzeń doprecyzowuje definicje, raportowanie i działania naprawcze. Dla pracodawców najważniejsza jest jednak gotowość operacyjna.
excerpt: Drugi polski projekt wdrożenia dyrektywy 2023/970 pokazuje wyraźniej, jak mają wyglądać raportowanie, wartościowanie pracy i reakcja na luki płacowe. To sygnał, że czas na porządkowanie systemu wynagrodzeń właśnie się kończy.
permalink: /aktualnosci/drugi-projekt-ustawy-o-jawnosci-wynagrodzen-co-sie-zmienilo/
...
<div class="post-header">
  ...
  <figure class="post-figure">
    <img src="/images/aktualnosci/drugi-projekt-jawnosc-wynagrodzen-sejm.jpg" alt="Sala posiedzeń Sejmu z polską flagą i godłem państwowym" loading="eager" decoding="async" />
    <figcaption>Photo by <a href="https://unsplash.com/@cierek?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Piotr Cierkosz</a> on <a href="https://unsplash.com/photos/red-white-and-blue-flag-on-white-wall-aDJT4Oj-BhE?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a></figcaption>
  </figure>
  <h1 class="post-title">Drugi projekt ustawy o jawności wynagrodzeń. Co się wyjaśniło i na co firmy powinny patrzeć teraz</h1>
</div>
