...
heading: Umów prezentację
description: Jeśli chcesz umówić prezentację systemu, wypełnij formularz.
permalink: /kontakt-demo/
alternateLangs:
  pl: /kontakt-demo/
contactPage: true
...
<div class="contact-form-shell">
  <form class="contact-form" name="wdrozenie-kontakt" method="POST" action="/kontakt-demo/dziekujemy/" data-form-purpose="implementation-contact" data-submit-endpoint="https://konto.systemjawnosciwynagrodzen.pl/backend-api/public/contact/implementation">
