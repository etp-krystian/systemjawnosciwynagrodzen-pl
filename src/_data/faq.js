const items = [
  {
    question: "Czym jest dyrektywa o jawności wynagrodzeń?",
    answer:
    ...
    shortAnswer:
      "To unijne przepisy wzmacniające zasadę równej płacy za taką samą pracę lub pracę o tej samej wartości. Obejmują one informacje dla kandydatów i pracowników, raportowanie różnic wynagrodzeń oraz obowiązek opierania płac na obiektywnych kryteriach.",
  },
  {
    question: "Kiedy przepisy dotyczące jawności wynagrodzeń zaczną obowiązywać?",
    answer:
    ...
    shortAnswer:
      "Na poziomie UE państwa członkowskie miały wdrożyć dyrektywę do 7 czerwca 2026 r. Dokładny moment stosowania obowiązków wobec pracodawców zależy jednak od przepisów krajowych i ich wejścia w życie.",
  },
  {
    question: "Które firmy obejmą nowe obowiązki?",
    answer:
    ...
    shortAnswer:
      "Pełne obowiązki raportowe dotyczą co najmniej części pracodawców zatrudniających od 100 osób wzwyż, z różną częstotliwością zależną od skali firmy. Szersze zasady przejrzystości i obiektywnych kryteriów płacowych mają jednak znaczenie także poza samym raportowaniem.",
  },
  {
    question: "Czy pracodawca będzie musiał publikować wynagrodzenia?",
    answer:
    ...
    shortAnswer:
      "Nie chodzi o publiczne ujawnianie pensji każdej osoby. Dyrektywa rozróżnia informacje dla kandydatów, prawa informacyjne pracowników oraz raportowanie zagregowanych różnic wynagrodzeń.",
  },
  {
    question: "Czy trzeba podawać widełki wynagrodzeń w ogłoszeniach o pracę?",
    answer:
    ...
    shortAnswer:
      "Kandydat ma otrzymać informację o wynagrodzeniu początkowym lub jego przedziale. W praktyce oznacza to potrzebę posiadania spójnych widełek, nawet jeśli szczegółowy sposób publikacji zależy od przepisów krajowych.",
  },
  {
    question: "Czym jest luka płacowa?",
    answer:
    ...
    shortAnswer:
      "Luka płacowa to różnica między poziomem wynagrodzeń kobiet i mężczyzn, wyrażona procentowo. Jej interpretacja wymaga sprawdzenia, jakie grupy są porównywane i czy różnice można uzasadnić obiektywnymi kryteriami.",
  },
  {
    question: "Jak raportować lukę płacową?",
    answer:
    ...
    shortAnswer:
      "Raportowanie wymaga nie tylko danych płacowych, ale też spójnych kategorii pracy i metodologii porównania. Dyrektywa obejmuje kilka wskaźników, więc samo zestawienie średnich zwykle nie wystarcza.",
  },
  {
    question: "Co oznacza próg 5% różnicy wynagrodzeń?",
    answer:
    ...
    shortAnswer:
      "Próg 5% działa jak sygnał do pogłębionej oceny, a nie jak automatyczne stwierdzenie naruszenia. Znaczenie ma to, czy różnicę da się obiektywnie uzasadnić i czy została usunięta w wymaganym czasie.",
  },
  {
    question: "Jak przygotować firmę do nowych wymagań?",
    answer:
    ...
    shortAnswer:
      "Przygotowanie zwykle zaczyna się od porządku w stanowiskach, poziomach, kryteriach wartości pracy i danych pracowniczych. Dopiero na tej podstawie można stabilnie zbudować widełki płac i raportowanie.",
  },
  {
    question: "Jakie dane należy gromadzić?",
    answer:
    ...
    shortAnswer:
      "Potrzebne są dane o stanowisku, poziomie, strukturze organizacyjnej i wszystkich istotnych składnikach wynagrodzenia. Ważna jest nie tylko kompletność, ale też spójność definicji i możliwość porównywania podobnych ról.",
  },
  {
    question: "Czy wartościowanie stanowisk jest obowiązkowe?",
    answer:
    ...
    shortAnswer:
      "Przepisy nie narzucają jednej obowiązkowej metody wartościowania. W praktyce jednak uporządkowana ocena wartości pracy bardzo pomaga spełnić wymóg obiektywnych i neutralnych kryteriów porównania stanowisk.",
  },
  {
    question: "Dlaczego wartościowanie stanowisk pomaga w jawności wynagrodzeń?",
    answer:
    ...
    shortAnswer:
      "Wartościowanie pomaga porównać role według wspólnych kryteriów, a nie wyłącznie nazw stanowisk. Dzięki temu łatwiej budować poziomy, widełki i uzasadniać różnice płac w sposób obiektywny.",
  },
  {
    question: "Czym są poziomy stanowisk?",
    answer:
    ...
    shortAnswer:
      "Poziomy stanowisk porządkują role według odpowiedzialności, samodzielności i wartości pracy. Dzięki nim łatwiej spójnie łączyć stanowiska z wynagrodzeniem, awansem i porównywaniem podobnych ról.",
  },
  {
    question: "Czym są widełki wynagrodzeń?",
    answer:
    ...
    shortAnswer:
      "Widełki wynagrodzeń to przedziały płac przypisane do stanowisk lub poziomów. Pomagają one podejmować decyzje płacowe w sposób spójny i możliwy do uzasadnienia.",
  },
  {
    question: "Czy Excel wystarczy do przygotowania firmy?",
    answer:
    ...
    shortAnswer:
      "Excel może wystarczyć do prostego przeglądu danych, ale rzadko dobrze skaluje się do stałego utrzymania struktury stanowisk i analiz płacowych. Największym wyzwaniem stają się spójność danych, historia zmian i powtarzalność metodologii.",
  },
  {
    question: "Jak porównać wynagrodzenia osób wykonujących podobną pracę?",
    answer:
    ...
    shortAnswer:
      "Najpierw trzeba ustalić wspólną kategorię pracy, a dopiero potem porównywać płace. Sama nazwa stanowiska zwykle nie wystarcza, jeśli nie wiadomo, jaki jest poziom roli i zakres odpowiedzialności.",
  },
  {
    question: "Czy pracownicy będą mogli pytać o wynagrodzenia innych osób?",
    answer:
    ...
    shortAnswer:
      "Pracownik nie dostaje automatycznie dostępu do indywidualnych pensji innych osób. Może natomiast żądać informacji o swoim poziomie płacy i o średnich poziomach płac dla porównywalnej kategorii pracy, z podziałem na płeć.",
  },
  {
    question: "Jakie ryzyka niesie brak przygotowania?",
    answer:
    ...
    shortAnswer:
      "Brak przygotowania zwiększa ryzyko regulacyjne, operacyjne i reputacyjne. Najczęściej problemem okazuje się nie tylko sam raport, ale brak spójnych odpowiedzi na pytania o zasady płacowe i porównywalność ról.",
  },
  {
    question: "Czy system zastępuje doradztwo prawne?",
    answer:
    ...
    shortAnswer:
      "Nie. System może porządkować dane i wspierać analizę, ale nie zastępuje interpretacji przepisów ani doradztwa prawnego w konkretnych sytuacjach organizacji.",
  },
  {
    question: "Od czego zacząć przygotowanie organizacji?",
    answer:
...
const normalizedItems = items.map((item) => ({
  ...
  href: `/faq/#${slugify(item.question)}`,
}));

const pick = (question, overrideQuestion) => {
  const match = normalizedItems.find((item) => item.question === question);
  return {
    question: overrideQuestion || match.question,
...
const homepageItems = [
  pick("Czym jest dyrektywa o jawności wynagrodzeń?"),
  pick("Które firmy obejmą nowe obowiązki?"),
  pick("Czy pracodawca będzie musiał publikować wynagrodzenia?"),
  pick("Czym jest luka płacowa?"),
  pick("Jak przygotować firmę do nowych wymagań?"),
  pick("Czym są widełki wynagrodzeń?", "Czy potrzebne są widełki wynagrodzeń?"),
  pick("Czy wartościowanie stanowisk jest obowiązkowe?"),
  pick("Jakie dane należy gromadzić?"),
];
